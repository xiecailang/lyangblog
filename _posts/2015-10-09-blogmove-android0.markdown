...
最近做了一个项目，要适应横屏和竖屏，其中有一个模块用到了ListView来显示较多的数据，这就遇到了一个问题，ListView是默认向下滑动的，当列数过多不做处理时，竖屏无法显示显示所有列。
...
layout-port
```html
<com.cstx_railway_works_assistant.views.HorizontalListView
